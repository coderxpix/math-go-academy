-- Fix submit_test_attempt to not update generated columns percentage and grade
...
BEGIN
  ...
  -- Update test attempt without setting generated always columns (percentage and grade)
