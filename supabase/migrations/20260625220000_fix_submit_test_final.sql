-- Final fix: ensure submit_test_attempt does NOT touch generated columns (percentage, grade)
...
BEGIN
  ...
  -- Insert answers (upsert to avoid duplicates)
  ...
  -- Update ONLY non-generated columns (do NOT touch percentage or grade)
