...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const dest = normalizedEmail === 'admin2o1o@jbn.jbn' ? '/admin' : from;
      ...
      <Card className="relative w-full max-w-md shadow-xl border-border/50">
        ...
        <CardContent>
          <Button 
            type="button" 
            variant="outline" 
            className="w-full h-12 mb-6 font-medium text-base relative overflow-hidden" 
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground">Yoki email orqali</span>
            </div>
          </div>
